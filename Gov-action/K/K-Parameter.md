...
"Within the Cardano documentation, a pool that reaches its maximum size is said to be saturated. A saturated pool offers the highest rewards to delegators and is most lucrative for its operators, while an over-saturated pool delivers lower rewards."[^3]
...
Increasing K or Target Number of Stake Pools (stakePoolTargetNum) would align with and satisfy both, the goal and the Core Metric.
